...
function GretCharByPosition(){
    var cadena = promp("Ingrese una Cadena" , "Hola Mundo")
    var pos = parseInt(prompt("Ingrese Position ", 3))
    var caracter = cadena[pos]
    alert (caracter)
}


function jeintwostring(){
    var cadenaA = promp("Ingrese una Cadena" , "Hola Mundo")
    var cadenaB = prompt("Ingrese una Cadena", "Mundo Hola" )
    var unir = cadenaA + cadenaB
    alert (unir)
}


function GetfrecuencyChar() {
    var cadena = promp("Ingrese una Cadena" , "Universidad Cumbre")
...
function MynameINACEII(){ //nombre completo
    var var_J = String. fromCharCode(74); 
    ...
    alert(var_J + var_h + var_o + var_c + var_i + var_a + var_s)

    //mostrar el abecedario
    inicio = 97 
    fin = 122
    while (fn >= inicio) {
        var letra = string.fromCarCode(inicio);
        alert(letra)
    }
